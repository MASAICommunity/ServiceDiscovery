...
${nuget_cmd} install src/ServiceDiscovery/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/ServiceDiscovery.dll"
mcs -langversion:${langversion} -sdk:${sdk} -r:bin/Newtonsoft.Json.dll,bin/JsonSubTypes.dll,\
bin/RestSharp.dll,\
System.ComponentModel.DataAnnotations.dll,\
System.Runtime.Serialization.dll \
-target:library \
-out:bin/ServiceDiscovery.dll \
-recurse:'src/ServiceDiscovery/*.cs' \
-doc:bin/ServiceDiscovery.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/ServiceDiscovery.dll was created successfully"
fi

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ServiceDiscovery.JsonXmlObject();
  });
  ...
  describe('JsonXmlObject', function() {
    it('should create an instance of JsonXmlObject', function() {
      // uncomment below and update the code to test JsonXmlObject
      //var instane = new ServiceDiscovery.JsonXmlObject();
      //expect(instance).to.be.a(ServiceDiscovery.JsonXmlObject);
    });

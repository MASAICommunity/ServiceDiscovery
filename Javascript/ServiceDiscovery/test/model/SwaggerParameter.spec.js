...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ServiceDiscovery.SwaggerParameter();
  });
  ...
  describe('SwaggerParameter', function() {
    it('should create an instance of SwaggerParameter', function() {
      // uncomment below and update the code to test SwaggerParameter
      //var instane = new ServiceDiscovery.SwaggerParameter();
      //expect(instance).to.be.a(ServiceDiscovery.SwaggerParameter);
    });
    ...
    it('should have the property allowEmptyValue (base name: "allowEmptyValue")', function() {
      // uncomment below and update the code to test the property allowEmptyValue
      //var instane = new ServiceDiscovery.SwaggerParameter();
      //expect(instance).to.be();
    });
    ...
    it('should have the property xNullable (base name: "x-nullable")', function() {
      // uncomment below and update the code to test the property xNullable
      //var instane = new ServiceDiscovery.SwaggerParameter();
      //expect(instance).to.be();
    });

    it('should have the property collectionFormat (base name: "collectionFormat")', function() {
      // uncomment below and update the code to test the property collectionFormat
      //var instane = new ServiceDiscovery.SwaggerParameter();
      //expect(instance).to.be();
    });

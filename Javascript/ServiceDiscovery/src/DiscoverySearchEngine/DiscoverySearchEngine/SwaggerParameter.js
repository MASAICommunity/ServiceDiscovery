...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.DiscoverySearchEngine.SwaggerParameter = factory(root.DiscoverySearchEngine.ApiClient, root.DiscoverySearchEngine.JsonSchema4, root.DiscoverySearchEngine.JsonXmlObject);
  }
  ...
  /**
   * The SwaggerParameter model module.
   * @module DiscoverySearchEngine/DiscoverySearchEngine/SwaggerParameter
   * @version v1
   */

  /**
   * Constructs a new <code>SwaggerParameter</code>.
   * Describes an operation parameter.
   * @alias module:DiscoverySearchEngine/DiscoverySearchEngine/SwaggerParameter
   * @class
   */
  ...
  /**
   * Constructs a <code>SwaggerParameter</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:DiscoverySearchEngine/DiscoverySearchEngine/SwaggerParameter} obj Optional instance to populate.
   * @return {module:DiscoverySearchEngine/DiscoverySearchEngine/SwaggerParameter} The populated <code>SwaggerParameter</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('allowEmptyValue')) {
        obj['allowEmptyValue'] = ApiClient.convertToType(data['allowEmptyValue'], 'Boolean');
      }
      if (data.hasOwnProperty('schema')) {
      ...
      if (data.hasOwnProperty('collectionFormat')) {
        obj['collectionFormat'] = ApiClient.convertToType(data['collectionFormat'], 'String');
      }
   ...
   * @member {module:DiscoverySearchEngine/DiscoverySearchEngine/SwaggerParameter.InEnum} in
   */
   ...
   * @member {Boolean} allowEmptyValue
   */
  exports.prototype['allowEmptyValue'] = undefined;
  /**
   ...
   * @member {module:DiscoverySearchEngine/DiscoverySearchEngine/SwaggerParameter.CollectionFormatEnum} collectionFormat
   */
  exports.prototype['collectionFormat'] = undefined;
  /**
  ...
  /**
   * Allowed values for the <code>collectionFormat</code> property.
   * @enum {String}
   * @readonly
   */

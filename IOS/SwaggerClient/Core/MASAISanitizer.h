...
extern NSString * MASAIPercentEscapedStringFromString(NSString *string);

extern NSString * const kMASAIApplicationJSONType;

@protocol MASAISanitizer <NSObject>
...
@interface MASAISanitizer : NSObject <MASAISanitizer>

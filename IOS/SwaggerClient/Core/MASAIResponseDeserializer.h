 ...
 */
extern NSString *const MASAIDeserializationErrorDomainKey;

/**
 * Code for deserialization type mismatch error
 */
extern NSInteger const MASAITypeMismatchErrorCode;

/**
 * Code for deserialization empty value error
 */
extern NSInteger const MASAIEmptyValueOccurredErrorCode;

/**
 * Error code for unknown response
 */
extern NSInteger const MASAIUnknownResponseObjectErrorCode;

@protocol MASAIResponseDeserializer <NSObject>
...
@interface MASAIResponseDeserializer : NSObject <MASAIResponseDeserializer>

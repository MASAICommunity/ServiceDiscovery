#import "MASAIResponseDeserializer.h"
#import <JSONModel/JSONModel.h>
#import <ISO8601/ISO8601.h>

NSString *const MASAIDeserializationErrorDomainKey = @"MASAIDeserializationErrorDomainKey";

NSInteger const MASAITypeMismatchErrorCode = 143553;

NSInteger const MASAIEmptyValueOccurredErrorCode = 143509;

NSInteger const MASAIUnknownResponseObjectErrorCode = 143528;


@interface MASAIResponseDeserializer ()
...
@implementation MASAIResponseDeserializer
...
-(NSError *)typeMismatchErrorWithExpectedType:(NSString *)expected data:(id)data {
    ...
    return [NSError errorWithDomain:MASAIDeserializationErrorDomainKey code:MASAITypeMismatchErrorCode userInfo:userInfo];
}
...
-(NSError *)emptyValueOccurredError {
    ...
    NSDictionary * userInfo = @{NSLocalizedDescriptionKey : message};
    return [NSError errorWithDomain:MASAIDeserializationErrorDomainKey code:MASAIEmptyValueOccurredErrorCode userInfo:userInfo];
}
...
-(NSError *)unknownResponseErrorWithExpectedType:(NSString *)expected data:(id)data  {
    ...
    NSDictionary * userInfo = @{NSLocalizedDescriptionKey : message};
    return [NSError errorWithDomain:MASAIDeserializationErrorDomainKey code:MASAIUnknownResponseObjectErrorCode userInfo:userInfo];
}

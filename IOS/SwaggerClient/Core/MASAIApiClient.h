 ...
 */
extern NSString *const MASAIResponseObjectErrorKey;


@interface MASAIApiClient : AFHTTPSessionManager

@property (nonatomic, strong, readonly) id<MASAIConfiguration> configuration;

@property(nonatomic, assign) NSTimeInterval timeoutInterval;

@property(nonatomic, strong) id<MASAIResponseDeserializer> responseDeserializer;

@property(nonatomic, strong) id<MASAISanitizer> sanitizer;

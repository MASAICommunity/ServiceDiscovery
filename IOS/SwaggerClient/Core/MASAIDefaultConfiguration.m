...
#import "MASAIBasicAuthTokenProvider.h"
#import "MASAILogger.h"

@interface MASAIDefaultConfiguration ()
...
@implementation MASAIDefaultConfiguration

#pragma mark - Singleton Methods

+ (instancetype) sharedConfig {
    static MASAIDefaultConfiguration *shardConfig = nil;
...
- (instancetype) init {
    self = [super init];
    if (self) {
        _host = @"http://apis.masai.teleticketing.eu/ServiceDiscovery";
        _username = @"";
        _password = @"";
        _accessToken= @"";
        _verifySSL = YES;
        ...
        _logger = [MASAILogger sharedLogger];
    }
    return self;
}
...
- (NSString *) getBasicAuthToken {
    ...
    NSString *basicAuthToken = [MASAIBasicAuthTokenProvider createBasicAuthTokenWithUsername:self.username password:self.password];
